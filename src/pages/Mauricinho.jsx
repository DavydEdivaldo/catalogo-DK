    ...
    <div className="min-h-screen w-full bg-[#121214] !text-white !pt-32 !pb-16 !px-4 !sm:px-6 !lg:px-8 !font-sans">
      ...
      <div className="!max-w-7xl !mx-auto !mb-10">
        ...
        <h1 className="!text-3xl !md:text-4xl !font-light !tracking-tight">
          <span className="!font-medium bg-clip-text text-transparent bg-gradient-to-r !from-white !to-neutral-400">Shorts Mauricinho</span>
        </h1>
      </div>
      ...
      <main className="!max-w-7xl !mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 !gap-4">
          ...
          {listaProdutos.map((produto) => (
            <div
              key={produto.id}
              className="bg-[#1e1e22] !rounded-xl !overflow-hidden !shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between !group cursor-pointer"
            >
              {/* Imagem do Produto */}
              <div className="w-full bg-[#DCCFC7] aspect-square flex items-center justify-center overflow-hidden  relative">
                <img
                  src={produto.imagem}
                  alt={produto.nome}
              ...
              {/* Informações do Card */}
              <div className="!p-4 flex flex-col flex-grow justify-between bg-[#29292e]">
